...
def main():
    ...
    if mc.is_solr_local(confdir):
        ...
        #if os.path.exists('/data/solr/vertex_index_shard1_replica_n1/data/index/write.lock'):
        #   os.remove('/data/solr/vertex_index_shard1_replica_n1/data/index/write.lock')
        if not os.path.exists('/data/solr/vertex_index_shard1_replica_n1'):
           mc.create_solr_collection(mc.solrBinDir(atlas_home), mc.solrConfDir(atlas_home), "vertex_index", logdir)
          
        #if os.path.exists('/data/solr/edge_index_shard1_replica_n1/data/index/write.lock'):
        #   os.remove('/data/solr/edge_index_shard1_replica_n1/data/index/write.lock')
        if not os.path.exists('/data/solr/edge_index_shard1_replica_n1'):
           mc.create_solr_collection(mc.solrBinDir(atlas_home), mc.solrConfDir(atlas_home), "edge_index", logdir)
        
        #if os.path.exists('/data/solr/fulltext_index_shard1_replica_n1/data/index/write.lock'):
        #   os.remove('/data/solr/fulltext_index_shard1_replica_n1/data/index/write.lock')           
        if not os.path.exists('/data/solr/fulltext_index_shard1_replica_n1'):
